...
person_tile = Tile(zero_x, zero_y, len(fields)//2, len(fields[0])//2, size_tile, enemy)
...
while running:
    ...
    person_tile.update(zero_x + person_x * size_tile, zero_y + person_y * size_tile, size_tile)
